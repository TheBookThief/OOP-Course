...
class Weapon : public Item
{
    ...
    public:
        Weapon(){}
        Weapon(const std::string &name, const std::string &description, const int attackPower, AttackType attackType) : 
            Item(name, description, 3), durability(1.), attackPower(attackPower), attackType(attackType) {}
        void print(std::ostream &os) override
        {
            Item::print(os);
...
class Armor : public Item
{
    ...
    public:
        Armor(){}
        Armor(const std::string &name, const std::string &description, const int protection, const std::vector<AttackType> &types)
            : Item(name, description, 3), protection(protection), damageTypes(types) {}
        void print(std::ostream &os) override 
        {
            Item::print(os);
